    ...
    <div className="m-t-20 relative content-w-760">
      ...
      <div className="mb-[20px] mt-6">
        <div className="flex flex-wrap justify-between gap-5 sm:flex-nowrap">
          <div className="flex w-full flex-wrap items-center justify-between gap-[15px] sm:gap-[20px] sm:w-[520px]">
            {mockList.map((item, index) => {
              return (
                <div
                  className="flex w-[44vw] h-[44vw] sm:h-[240px] sm:w-[240px] flex-col items-center justify-center rounded-[20px] bg-[rgba(255,255,255,0.1)] backdrop-blur-md "
                  key={index}
                ></div>
              );
            })}
