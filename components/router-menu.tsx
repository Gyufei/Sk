...
function MenuItem({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="bg-blur12 flex h-[28vw] w-[28vw]  min-w-[105px] min-h-[105px] cursor-pointer flex-col items-center justify-center gap-y-2 rounded-[20px] bg-[rgba(255,255,255,0.1)] hover:bg-[rgba(255,255,255,0.2)] sm:h-[120px] sm:w-[120px]"
    >
      {children}
    </div>
  );
